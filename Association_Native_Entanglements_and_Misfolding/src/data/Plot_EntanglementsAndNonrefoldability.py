...
class Plotter:
    ...
    def plot_data(self,):
        ...
        outfile = os.path.join(self.outpath, f'entanglement_and_nonrefoldability_Fisher_results_{self.tag}.png')
        ...
        plt.suptitle(f'Assoc. Ent & Nonrefoldability | {self.tag} | {buff_tag[buff]}')
        plt.tight_layout()
        #plt.show()
        plt.savefig(outfile)
        plt.close()
