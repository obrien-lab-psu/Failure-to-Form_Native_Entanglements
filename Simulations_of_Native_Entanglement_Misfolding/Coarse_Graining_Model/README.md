...
## Results
You can check the status of the optimization using the following script. Just make sure to change the hardcoded paths in it to fit your system. It will produce a tabled .csv file in your data/ directory that looks like [this](data/Check.csv). This script will also make a directory in your [SLUG] for the protein of interest and copy the final CG files there if the optimization was complete.  
```
python src/data/Check_status.py
```
  
| Index | Gene   | PDB   | Chain | Length | Dom Type(s)\*                                              | Status | nscales                                                                                                         |
|-------|--------|-------|-------|--------|-----------------------------------------------------------|--------|----------------------------------------------------------------------------------------------------------------|
| 0     | P0A6B4 | 4WR3  | A     | 359    | 1:9 218:359 b<br>10:217 c                                 | TRUE   | Domain 1: nscal = 1.4732<br>Domain 2: nscal = 1.1556<br>Interface 1\|2: nscal = 2.5044                          |
| 1     | P0A6E6 | 1AQT  | A     | 139    | 1:90 b<br>91:139 a                                       | TRUE   | Domain 1: nscal = 1.8120<br>Domain 2: nscal = 1.4704<br>Interface 1\|2: nscal = 1.8611                          |
...
| 11    | P0ACP7 | 1QPZ  | A     | 341    | 1:58 a<br>59:160 291:322 c<br>161:290 323:341 c          | TRUE   | Domain 1: nscal = 2.5044<br>Domain 2: nscal = 1.4213<br>Domain 3: nscal = 1.4213<br>Interface 1\|2: nscal = 1.2747<br>Interface 1\|3: nscal = 1.2747<br>Interface 2\|3: nscal = 1.5679 |
| 12    | P0ADY3 | 6XZ7  | K     | 123    | 1:123 b                                                  | TRUE   | Domain 1: nscal = 1.4732                                                                                       |
| 13    | P0ADZ0 | 6QUL  | U     | 100    | 1:100 c                                                  | TRUE   | Domain 1: nscal = 1.9644                                                                                       |
| 14    | P0AES0 | 2IO9  | B     | 619    | 1:200 c<br>201:619 c                                     | TRUE   | Domain 1: nscal = 1.1556<br>Domain 2: nscal = 1.1556<br>Interface 1\|2: nscal = 1.8611                          |
| 15    | P0AG51 | 6XZ7  | Z     | 59     | 1:59 c                                                   | TRUE   | Domain 1: nscal = 1.9644                                                                                       |
| 16    | P21599 | 6K0K  | A     | 480    | 1:480 c                                                  | TRUE   | Domain 1: nscal = 1.1556                                                                                       |
| 17    | P31142 | 1URH  | A     | 281    | 1:149 c<br>150:281 c                                     | TRUE   | Domain 1: nscal = 1.1556<br>Domain 2: nscal = 1.1556<br>Interface 1\|2: nscal = 2.5044                          |
| 18    | P37747 | 1I8T  | A     | 367    | 1:79 182:239 315:367 c<br>80:181 240:314 c               | TRUE   | Domain 1: nscal = 1.1556<br>Domain 2: nscal = 1.1556<br>Interface 1\|2: nscal = 1.8611                          |
| 19    | P45748 | 1HRU  | A     | 190    | 1:190 c                                                  | TRUE   | Domain 1: nscal = 1.1556                                                                                       |
| 20    | P60438 | 6PCR  | N     | 209    | 1:209 b                                                  | TRUE   | Domain 1: nscal = 2.1508                                                                                       |
| 21    | P60546 | 2ANB  | A     | 207    | 1:36 97:207 c<br>37:96 c                                 | TRUE   | Domain 1: nscal = 1.4213<br>Domain 2: nscal = 1.9644<br>Interface 1\|2: nscal = 2.1670                          |
...
<a id="7">[7]</a>: Jiang, Y., Neti, S.S., Sitarik, I. et al. How synonymous mutations alter enzyme structure and function over long timescales. Nat. Chem. 15, 308–318 (2023). https://doi.org/10.1038/s41557-022-01091-z  
