...
for set_type in ['EXP', 'AF']:
    for buff in ['C', 'CG', 'CD']:
        for i in range(0,10):
            ...
            outpath = f'-o {path_to_slug}/Candidate_Selection_for_CG_T-quench_Sims/{set_type}/{i}/'
            ...
            logs = f'-l {path_to_slug}/Candidate_Selection_for_CG_T-quench_Sims/logs/{set_type}_{buff}_{i}.log'
            tag  = f'-t {set_type}_{buff}_traj{i} -b {buff} -s 50 -c 50 -r "cut_{buff}_Rall ~ AA + region" --random False -n 5 -beta 0.05 -C1 1 -C2 1 --steps 100000'
