...
def main():
    ...
    parser.add_argument("-dDE", "--deltaDeltaE", type=str, required=True, help="path to deltaDeltaE file to plot or OR file to plot")
    parser.add_argument("-dDEp", "--deltaDeltaE_pvalues", type=str, required=True, help="path to fdr pvalues file for deltaDeltaE or OR")
